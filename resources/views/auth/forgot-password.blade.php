                        ...
                        <div class="col-md-8 col-lg-6 col-xl-12 col-xxl-9 mx-auto">
                            ...
                            <div class="card bg-transparent border-0 mb-0">
                                <div class="p-md-8 card-body">
                                    <h4 class="text-gradient fw-bold text-uppercase mb-2">Lupa Kata Sandi</h4>
                                    <p class="text-muted mb-6">Masukkan alamat email Anda yang terdaftar untuk menerima
                                        link pemulihan kata sandi.</p>
                                    ...
                                    <form action="{{ route('password.email') }}" method="POST">
                                        ...
                                        <div class="row g-5 mt-3">
                                            ...
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary w-100 py-2.5">Kirim Link
                                                    Pemulihan</button>
                                            </div>
                                            <div class="col-12">
                                                <p class="text-center text-muted">Kembali ke halaman <a
                                                        href="{{ route('login') }}"
                                                        class="link link-primary fw-semibold">Masuk</a></p>
                                            </div>
                                        </div>
                                    </form>
                                </div>
