<x-app>
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="gap-2 page-heading mb-4 flex-column flex-md-row d-flex align-items-center justify-content-between">
                <div>
                    <h6 class="mb-0">Tambah Data Penduduk (Warga)</h6>
                    <p class="text-muted fs-13 mb-0">Tambah warga baru beserta nilai indikator kriteria PKH dan koordinat geografis</p>
                </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6 border-end pe-md-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nik" value="{{ old('nik') }}" class="form-control @error('nik') is-invalid @enderror" placeholder="Contoh: 3529012345670001" required>
                                            @error('nik')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama" value="{{ old('nama') }}" class="form-control @error('nama') is-invalid @enderror" placeholder="Contoh: Aidah" required>
                                            @error('nama')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="dusun" class="form-select @error('dusun') is-invalid @enderror">
                                                ...
                                                <option value="CAMPOR" {{ old('dusun') == 'CAMPOR' ? 'selected' : '' }}>CAMPOR</option>
                                                <option value="KOLPOH" {{ old('dusun') == 'KOLPOH' ? 'selected' : '' }}>KOLPOH</option>
                                                <option value="TANA MERA" {{ old('dusun') == 'TANA MERA' ? 'selected' : '' }}>TANA MERA</option>
                                            </select>
                                            @error('dusun')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="2" placeholder="Contoh: Dusun Campor, Desa Campor Barat" required>{{ old('alamat') }}</textarea>
                                            @error('alamat')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 mb-3">
                                                ...
                                                <input type="text" id="latitude" name="latitude" value="{{ old('latitude', '-6.895000') }}" class="form-control @error('latitude') is-invalid @enderror" readonly required>
                                                @error('latitude')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="col-6 mb-3">
                                                ...
                                                <input type="text" id="longitude" name="longitude" value="{{ old('longitude', '113.785000') }}" class="form-control @error('longitude') is-invalid @enderror" readonly required>
                                                @error('longitude')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="col-md-6 ps-md-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="c1" value="{{ old('c1') }}" class="form-control @error('c1') is-invalid @enderror" placeholder="Contoh: 500000" required>
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="c2" value="{{ old('c2') }}" class="form-control @error('c2') is-invalid @enderror" placeholder="Contoh: 3" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="c3" class="form-select @error('c3') is-invalid @enderror" required>
                                                ...
                                                <option value="0" {{ old('c3') == '0' ? 'selected' : '' }}>Tidak Sekolah / PAUD (Skor 0)</option>
                                                <option value="1" {{ old('c3') == '1' ? 'selected' : '' }}>SD / Sederajat (Skor 1)</option>
                                                <option value="2" {{ old('c3') == '2' ? 'selected' : '' }}>SMP / Sederajat (Skor 2)</option>
                                                <option value="3" {{ old('c3') == '3' ? 'selected' : '' }}>SMA / SMK / Sederajat (Skor 3)</option>
                                            </select>
                                            @error('c3')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="c4" class="form-select @error('c4') is-invalid @enderror" required>
                                                ...
                                                <option value="1" {{ old('c4') == '1' ? 'selected' : '' }}>Tidak Layak Huni (Skor 1)</option>
                                                <option value="2" {{ old('c4') == '2' ? 'selected' : '' }}>Kurang Layak Huni (Skor 2)</option>
                                                <option value="3" {{ old('c4') == '3' ? 'selected' : '' }}>Layak Huni (Skor 3)</option>
                                            </select>
                                            @error('c4')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var defaultLat = -6.889722;
            var defaultLng = 113.756111;

            // Inisialisasi peta picker
            var map = L.map('picker-map').setView([defaultLat, defaultLng], 14);
